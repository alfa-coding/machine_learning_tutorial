...
cropper =CenterCrop(height=40, width=40)
rescaler =Rescaling(scale=1.0 / 255)
...
callbacks_custom = [
    keras.callbacks.ModelCheckpoint(
        filepath='sequential_saved/classification_model_epoch_{epoch}',
        save_freq='epoch'
        ),
        keras.callbacks.TensorBoard(log_dir='./sequential_logs')
]
